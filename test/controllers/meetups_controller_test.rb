...
class MeetupsControllerTest < ActionController::TestCase
  ...
  test "should create meetup" do
    assert_difference('Meetup.count') do
      post :create, meetup: { author_id: @meetup.author_id, close_at: @meetup.close_at, deadline: @meetup.deadline, intro: @meetup.intro, open_at: @meetup.open_at, place: @meetup.place, title: @meetup.title }
    end
  ...
  test "should update meetup" do
    patch :update, id: @meetup, meetup: { author_id: @meetup.author_id, close_at: @meetup.close_at, deadline: @meetup.deadline, intro: @meetup.intro, open_at: @meetup.open_at, place: @meetup.place, title: @meetup.title }
    assert_redirected_to meetup_path(assigns(:meetup))
  end
